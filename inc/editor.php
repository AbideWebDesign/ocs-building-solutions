 ...
 */
function ocs_block_editor_styles() {

	$css_dependencies = array();

	// Enqueue the editor styles.
	wp_enqueue_style( 'ocs-block-editor-styles', get_theme_file_uri( '/css/custom-editor-style.min.css' ), $css_dependencies, wp_get_theme()->get( 'Version' ), 'all' );
	wp_style_add_data( 'ocs-block-editor-styles', 'rtl', 'replace' );

}

add_action( 'enqueue_block_editor_assets', 'ocs_block_editor_styles', 1, 1 );
 ...
 *
*/
function ocs_acf_extension_enqueue() {
...
add_action( 'acf/input/admin_enqueue_scripts', 'ocs_acf_extension_enqueue' );
